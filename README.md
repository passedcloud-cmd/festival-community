# LocalHub (서울) - 실시간 축제 혼잡도 커뮤니티
 
> 이 프로젝트는 서울 지역의 주민과 관광객들이 공공데이터와 실시간 사용자 제보를 바탕으로 축제 현장의 혼잡도를 실시간으로 파악하고, AI 비서를 통해 축제 정보를 맞춤형으로 안내받을 수 있는 **서버리스(Serverless) 정적 SPA 커뮤니티**입니다.
